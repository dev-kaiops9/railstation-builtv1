...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div
        ...
        <div id="weather-data">
            ...
            @if($weather)
                <p class="text-gray-900 text-2xl font-bold mt-1">
            ...
            @else
                <p class="text-gray-500">Data cuaca tidak tersedia</p>
            @endif
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-md p-6 mb-8">
    <h2 class="text-xl font-bold text-gray-900 mb-2">Data Pegawai yang Berdinas Saat Ini</h2>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    ...
    <div class="flex items-center space-x-4 bg-gray-50 rounded-lg p-4 shadow-sm">
        <img class="w-16 h-16 rounded-full object-cover"
           src="{{ $employee->photo_url ? asset('storage/'.$employee->photo_url) : 'https://placehold.co/128x128/D1D5DB/1F2937?text=' . $employee->position }}"
    ...
    @empty
        <p class="text-gray-500">Belum ada pegawai yang berdinas pada shift ini</p>
    @endforelse
</div>

@else
<p class="text-gray-500">Tidak ada shift aktif saat ini</p>
@endif
</div>
@endsection
